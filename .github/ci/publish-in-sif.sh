...
# (project=scitex-etc, owner=ywatanabe1989, repo=scitex-etc,
...
TMPDIR="/tmp/publish-scitex_etc-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-etc dist/* uploaded to PyPI via manual OIDC trusted publishing"
